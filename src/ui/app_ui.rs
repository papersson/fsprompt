...
impl FsPromptApp {
    ...
    pub fn show_files_panel(&mut self, ui: &mut egui::Ui) {
        // Calculate how much space we need for controls
        let controls_height = 300.0; // Approximate height for all controls above tree
        
        // Use a top/bottom approach to guarantee tree gets space
